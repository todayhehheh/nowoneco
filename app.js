...
// ══════════════════════════════════════════════
const missions = [
  { day:'월요일', theme:'전기 아껴 쓰기', img:'img/001.webp', list:[
  ...
  { day:'화요일', theme:'일회용품 거절하기', img:'img/002.webp', list:[
  ...
  { day:'수요일', theme:'제대로 분리수거 하기', img:'img/003.webp', list:[
  ...
  { day:'목요일', theme:'가까운 거리는 걷기', img:'img/004.webp', list:[
  ...
  { day:'금요일', theme:'음식 남기지 않기', img:'img/005.webp', list:[
  ...
  { day:'토요일', theme:'물 낭비 줄이기', img:'img/006.webp', list:[
  ...
  { day:'일요일', theme:'일주일 돌아보며 쉬어가기', img:'img/007.webp', list:[
...
async function loadPosts() {
  ...
  try {
    ...
    var todayImgSrc = (todayMission && todayMission.img) ? todayMission.img : 'img/001.webp';
